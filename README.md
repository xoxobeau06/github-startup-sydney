...
- [X] [Step 1: Create Your Account and Tutorial Copy](docs/steps/01-account-and-template.md)
- [X] [Step 2: Create Local Repo Folder and Install VS Code](docs/steps/02-install-tools.md)
- [X] [Step 3: Link VS Code to GitHub](docs/steps/03-link-vscode-to-github.md)
- [X] [Step 4: Clone `github-startup` in VS Code Source Control](docs/steps/04-clone-repo-locally.md)
- [X] [Step 5: Link Antigravity to `github-startup`](docs/steps/05-link-antigravity.md)
- [X] [Step 6: Authorize GitHub Extension and Push](docs/steps/06-authorize-github-extension-and-push.md)
- [X] [Step 7: Deploy `github-startup` to GitHub Pages](docs/steps/07-deploy-temporary-pages.md)
- [X] [Step 8: Choose Your Project Path](docs/steps/08-choose-project-path.md)
